...
Database fullname
*/}}
{{- define "smartbox.database.fullname" -}}
{{- printf "%s-db" (include "smartbox.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Database selector labels
*/}}
{{- define "smartbox.database.selectorLabels" -}}
app.kubernetes.io/name: {{ include "smartbox.name" . }}-db
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
...
Portal fullname
*/}}
{{- define "smartbox.portal.fullname" -}}
{{- printf "%s-portal" (include "smartbox.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
