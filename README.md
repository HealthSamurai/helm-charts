# Health Samurai helm charts

This repository hosts Helm charts designed to simplify the deployment process of [Aidbox](https://www.health-samurai.io/docs/aidbox), [MPI](https://www.health-samurai.io/docs/aidbox/modules/mpi) in Kubernetes for Aidbox customers. Aidbox, a robust and scalable FHIR server, empowers healthcare providers and developers to manage healthcare data efficiently.
